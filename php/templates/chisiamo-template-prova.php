<div class="container col-xxl-12 px-4 py-5">
      ...
      <div class="row">
        <?php foreach ($templateParams["staff"] as $person): ?>
          ...
          <div class="col-lg-4 col-md-6 text-dark">
              <div class="card">
                <img class="img-fluid  mx-auto d-block" style="max-height:250px"  src="<?php echo UPLOAD_DIR.$person["img"]; ?>">
    ...
    <div class=" my-5 w-100  justify-content-center d-flex flex-column ">
      ...
      <div class="m-12">
        <iframe src="https://www.google.com/maps/d/u/0/embed?mid=1WRPurxOlrnI2ivMcUdXIvrWtLsKLkkHD" class="w-100" height="600px" ></iframe>
      </div>
